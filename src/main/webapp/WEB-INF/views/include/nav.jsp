...
<div class="w3-top">
  <div class="w3-bar w3-black w3-card">
    ...
    <c:if test="${empty sMid}">
	    <a href="${ctp}/admin/login" class="w3-bar-item w3-button w3-padding-large w3-hide-small">AdminLogin</a>
    </c:if>
    <c:if test="${not empty sMid}">
	    <a href="#" class="w3-bar-item w3-button w3-padding-large w3-hide-small">${sMid}(관리자) 접속중</a>
	    <a href="${ctp}/admin/logout" class="w3-bar-item w3-button w3-padding-large w3-hide-small">AdminLogout</a>
    </c:if>
    ...
    <div class="w3-dropdown-hover w3-hide-small">
      ...
      <div class="w3-dropdown-content w3-bar-block w3-card-4">
        ...
        <a href="${ctp}/shop/input/productList" class="w3-bar-item w3-button">옵션등록</a>
      </div>
    </div>
    <div class="w3-dropdown-hover w3-hide-small">
      ...
      <div class="w3-dropdown-content w3-bar-block w3-card-4">
        ...
        <c:if test="${sLevel == 0}">
	    <a href="${ctp}/" class="w3-bar-item w3-button">관리자메뉴</a>
        </c:if>
        <c:if test="${sLevel != 0}">
    ...
    <c:if test="${empty sLevel}"><a href="${ctp}/member/memLogin" class="w3-bar-item w3-button">로그인</a></c:if>
    <c:if test="${not empty sLevel}"><a href="${ctp}/member/memLogout" class="w3-bar-item w3-button">로그아웃</a></c:if>
